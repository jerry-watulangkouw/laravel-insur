...
@php
    ...
    $title='Make a Claim';
    $subTitle = 'Loan against Kmil Project';
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="make-a-claim__left">
                            <h3 class="make-a-claim__title-1">Loan against Kmil Project</h3>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="make-a-claim__img">
                                            <img src="{{ asset('assets/images/update-10-02-2023/resources/make-a-claim-img-3.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
