...
$css2=' <link rel="stylesheet" href="' . asset('assets/css/insur-rtl.css') . '">
        <link rel="stylesheet" href="' . asset('assets/css/insur-responsive-rtl.css') . '">
        <link rel="stylesheet" href="' . asset('assets/css/insur-rtl-custom.css') . '">
        <!-- toolbar css -->
        <link rel="stylesheet" href="' . asset('assets/vendors/layerdrops-toolbar/css/layerdrops-toolbar.css') . '">';
$counterone = 'false';
$script = '<script src="' . asset('assets/vendors/ion.rangeSlider/js/ion.rangeSlider.min.js') . '"></script>
           ...
           <script src="' . asset('assets/vendors/layerdrops-toolbar/js/js.cookie.min.js') . '"></script>
           <script src="' . asset('assets/vendors/layerdrops-toolbar/js/jQuery.style.switcher.min.js') . '"></script>
           <script src="' . asset('assets/vendors/layerdrops-toolbar/js/lang.js') . '"></script>
           <script src="' . asset('assets/translate.google.com/translate_a/element.js?cb=googleTranslateElementInit') . '"></script>
           <script src="' . asset('assets/vendors/layerdrops-toolbar/js/layerdrops-toolbar.js') . '"></script>';
@endphp
...
@section('content')
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                            <div class="feature-one__single">
                                <div class="feature-one__single-inner">
                                    ...
                                    <h3 class="feature-one__title"><a href="{{ route('about') }}">Get quote</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="{{ route('marriageInsurance') }}">Marriage
                                            insurance</a></h2>
                                    <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                        elit.</p>
                                </div>
        ...
        <section class="why-choose-one">
            ...
            <div class="why-choose-one-shape-4 float-bob-y">
                <img src="{{ asset('assets/images/update-11-09-2022/rtl/why-choose-one-shape-4.png') }}" alt="">
            </div>
            <div class="why-choose-one-shape-5 float-bob-y">
                <img src="{{ asset('assets/images/update-11-09-2022/rtl/why-choose-one-shape-5.png') }}" alt="">
            </div>
            <div class="why-choose-one-shape-6 float-bob-x">
                <img src="{{ asset('assets/images/shapes/why-choose-one-shape-6.png') }}" alt="">
            </div>
            <div class="why-choose-one-img wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                <img src="{{ asset('assets/images/update-11-09-2022/rtl/why-choose-one-img.png') }}" alt="">
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="get-insurance__left">
                            <div class="get-insurance__img wow slideInRight" data-wow-delay="100ms"
                                data-wow-duration="2500ms">
        ...
        <section class="team-one">
            <div class="team-one__shape-1 float-bob-y">
                <img src="{{ asset('assets/images/update-11-09-2022/rtl/team-one-shape-1.png') }}" alt="">
            </div>
            <div class="container">
        ...
        <section class="testimonial-one">
            <div class="testimonial-one-shape-2 float-bob-y">
                <img src="{{ asset('assets/images/update-11-09-2022/rtl/testimonial-one-shape-2.png') }}" alt="">
            </div>
                                    ...
                                    <div class="testimonial-one__single">
                                        <div class="testimonial-one__single-inner">
                                            <div class="testimonial-one__shape-1">
                                                <img src="{{ asset('assets/images/update-11-09-2022/rtl/testimonial-one-shape-1.png') }}"
                                                    alt="">
                                            </div>
