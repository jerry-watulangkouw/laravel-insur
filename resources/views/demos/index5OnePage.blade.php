                    ...
                    <div class="main-header-five__top-address">
                        <ul class="list-unstyled main-header-five__top-address-list">
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p>Jl. Cendrawasih, Cengkareng, Jakarta, Indonesia</p>
                                </div>
                            </li>
                            <li>
                                <i class="icon">
                                ...
                                <div class="text">
                                    <p><a href="tel:8898006802">0813-1629-7120
                                    </a></p>
                                </div>
                            </li>
                        </ul>
                            ...
                            <div class="services-five__img-box">
                                <div class="services-five__img">
                                    ...
                                    <div class="services-five__hover-content">
                                        ...
                                        <h4 class="services-five__hover-content-title"><a href="life-insurance') }}">Industrial Parts & Fabrication Project</a></h4>
                                        <p class="services-five__hover-content-text">There are many lipsum of <br>
                                            passages
                                            of available but the <br> have in that not some.</p>
                                    </div>
                            ...
                            <div class="services-five__img-box">
                                <div class="services-five__img">
                                    ...
                                    <div class="services-five__hover-content">
                                        ...
                                        <h4 class="services-five__hover-content-title"><a href="home-insurance') }}">Jig & Fixtures</a></h4>
                                        <p class="services-five__hover-content-text">There are many lipsum of <br>
                                            passages
                                            of available but the <br> have in that not some.</p>
                                    </div>
                            ...
                            <div class="services-five__img-box">
                                <div class="services-five__img">
                                    ...
                                    <div class="services-five__hover-content">
                                        ...
                                        <h4 class="services-five__hover-content-title"><a href="health-insurance') }}">Sheet Metal Processing</a></h4>
                                        <p class="services-five__hover-content-text">There are many lipsum of <br>
                                            passages
                                            of available but the <br> have in that not some.</p>
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-four__single">
                            <div class="team-four__img-box">
                                ...
                                <div class="team-four__content">
                                    <h4 class="team-four__name"><a href="{{ route('teamDetails') }}">A. </a></h4>
                                    <p class="team-four__text">Manager</p>
                                    <ul class="list-unstyled team-four__social-two">
                                        <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                                    </ul>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="site-footer-three__bottom-inner">
                            <p class="site-footer-three__bottom-text">© All Copyright 2025 by <a href="#">Jerry Schwarz</a>
                            </p>
