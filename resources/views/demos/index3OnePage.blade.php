...
@section('content')
                            ...
                            <div class="main-menu-three__right">
                                <div class="main-menu-three__search-get-quote-btn">
                                    <div class="main-menu-three__search-box">
                                        ...
                                        <a href="{{ route('cart') }}" class="main-menu-three__cart insur-two-icon-shopping-cart"></a>
                                </div>
                                <div class="main-menu-three__get-quote-btn-box">
                                    <a href="{{ route('contact') }}" class="thm-btn main-menu-three__get-quote-btn">Get a
                                        Quote</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="image-layer-three" style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-3-1.jpg') }}')"></div>
                    <!-- /.image-layer -->
                            ...
                            <div class="col-xl-12">
                                <div class="main-slider-three__content">
                                    ...
                                    <div class="main-slider-three__btn-box">
                                        <a href="{{ route('about') }}" class="thm-btn main-slider-three__btn">Let’s Get
                                            Started</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="image-layer-three" style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-3-2.jpg') }}')"></div>
                    <!-- /.image-layer -->
                ...
                <div class="swiper-slide">
                    <div class="image-layer-three" style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-3-3.jpg') }}')"></div>
                    <!-- /.image-layer -->
    ...
    <section class="feature-three">
        <div class="feature-three-shape float-bob-x">
            <img src="{{ asset('assets/images/shapes/feature-three-shape.png') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="about-three__left">
                        <div class="about-three__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                            ...
                            <div class="about-three__location">
                                <div class="about-three__location-bg" style="background-image: url('{{ asset('assets/images/shapes/about-three-shape-2.png') }}')">
                                </div>
                        ...
                        <div class="about-three__business-start">
                            ...
                            <div class="about-three__business-start-text-box">
                                <p class="about-three__business-start-text"> We’re in this business since
                                    <span>1987</span> and we provide the best services.
                                </p>
                            </div>
                        </div>
                        <p class="about-three__text">KMIL delivers precision-engineered solutions for industries demanding accuracy and reliability.</p>
                        <div class="about-three__bottom">
                            <div class="about-three__founder">
                                <div class="about-three__founder-img">
                                    <img src="{{ asset('assets/images/resources/about-three-founder-img.jpg') }}" alt="">
                                </div>
                                <div class="about-three__founder-content">
                                    <h3 class="about-three__founder-name">Rudiyanto Boen</h3>
                                    <p class="about-three__founder-sub-title">CEO of Kmil</p>
                                </div>
                            </div>
                            <div class="about-three__btn-box">
                                <a href="{{ route('about') }}" class="thm-btn about-three__btn">Let’s Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="services-three__inner">
                ...
                <div class="row">
                        ...
                        <div class="services-three__single">
                            <div class="services-three__img">
                                ...
                                <div class="services-three__content">
                                    <h3 class="services-three__title"><a href="{{ route('carInsurance') }}">Car <br>
                                            insurance</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="services-three__single">
                            <div class="services-three__img">
                                ...
                                <div class="services-three__content">
                                    <h3 class="services-three__title"><a href="{{ route('lifeInsurance') }}">Life <br>
                                            insurance</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="services-three__single">
                            <div class="services-three__img">
                                ...
                                <div class="services-three__content">
                                    <h3 class="services-three__title"><a href="{{ route('homeInsurance') }}">Home <br>
                                            insurance</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="services-three__single">
                            <div class="services-three__img">
                                ...
                                <div class="services-three__content">
                                    <h3 class="services-three__title"><a href="{{ route('healthInsurance') }}">Health <br>
                                            insurance</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <div class="services-three__single">
                            <div class="services-three__img">
                                <img src="{{ asset('assets/images/services/services-3-5.jpg') }}" alt="">
                                <div class="services-three__content">
                                    <h3 class="services-three__title"><a href="{{ route('businessInsurance') }}">Business
                                            <br> insurance</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-9 wow fadeInUp" data-wow-delay="700ms">
                        <div class="services-three__single">
                            <div class="services-three__get-quote">
                                ...
                                <a href="{{ route('insurance01') }}" class="thm-btn services-three__get-quote-btn">Get a
                                    Quote</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="benefits">
        <div class="benefits-bg" style="background-image: url('{{ asset('assets/images/backgrounds/benefits-bg.png') }}')"></div>
        <div class="benefits-bg-2" style="background-image: url('{{ asset('assets/images/backgrounds/benefits-bg-2.jpg') }}')">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="testimonial-three__left">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">KMIL</p>
                                    <div class="section-title-shape-1">
                                        <img src="{{ asset('assets/images/shapes/section-title-shape-1.png') }}" alt="">
                                    </div>
                                    <div class="section-title-shape-2">
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    ...
                                    <div class="testimonial-three__client">
                                        <h4 class="testimonial-three__client-name">Ilusio Melani Lim</h4>
                                        <p class="testimonial-three__client-sub-title">Top Management</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    ...
                                    <p class="testimonial-three__text">Pellentesque habitant morbi tristique
                                        ...
                                        aliquet blandit enim feugiat mattis.</p>
                                    <div class="testimonial-three__client">
                                        <h4 class="testimonial-three__client-name">Rudiyanto Boen</h4>
                                        <p class="testimonial-three__client-sub-title">CEO of Kmil</p>
                                    </div>
                                </div>
                            </div>
                            <!--Testimonial Three Single End-->
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    ...
                                    <p class="testimonial-three__text">Pellentesque habitant morbi tristique
                                        ...
                                        aliquet blandit enim feugiat mattis.</p>
                                    <div class="testimonial-three__client">
                                        <h4 class="testimonial-three__client-name">Elim Kurniawan</h4>
                                        <p class="testimonial-three__client-sub-title">Top Management</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    ...
                                    <p class="testimonial-three__text">Pellentesque habitant morbi tristique
                                        ...
                                        aliquet blandit enim feugiat mattis.</p>
                                    <div class="testimonial-three__client">
                                        <h4 class="testimonial-three__client-name">Fridolin</h4>
                                        <p class="testimonial-three__client-sub-title">director of Operasion</p>
                                    </div>
                                </div>
                            </div>
                            <!--Testimonial Three Single End-->
                                ...
                                <div class="tabs-content">
                                    ...
                                    <div class="tab active-tab" id="mission">
                                        <div class="we-provide__tab-main-content-inner">
                                            ...
                                            <div class="we-provide__tab-main-content-right">
                                                <div class="we-provide__tab-main-content-right-img">
                                                    <img src="{{ asset('assets/images/resources/we-provide-tab-main-content-right-img-2.jpg') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab" id="goals">
                                        <div class="we-provide__tab-main-content-inner">
                                            ...
                                            <div class="we-provide__tab-main-content-right">
                                                <div class="we-provide__tab-main-content-right-img">
                                                    <img src="{{ asset('assets/images/resources/we-provide-tab-main-content-right-img-3.jpg') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab" id="rewards">
                                        <div class="we-provide__tab-main-content-inner">
                                            ...
                                            <div class="we-provide__tab-main-content-right">
                                                <div class="we-provide__tab-main-content-right-img">
                                                    <img src="{{ asset('assets/images/resources/we-provide-tab-main-content-right-img-4.jpg') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab" id="choose">
                                        <div class="we-provide__tab-main-content-inner">
                                            ...
                                            <div class="we-provide__tab-main-content-right">
                                                <div class="we-provide__tab-main-content-right-img">
                                                    <img src="{{ asset('assets/images/resources/we-provide-tab-main-content-right-img-5.jpg') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                    <div class="news-three__single">
                        <div class="news-three-bg" style="background-image: url('{{ asset('assets/images/blog/news-3-1.jpg') }}')">
                        </div>
                        ...
                        <div class="news-three__content">
                            <h3 class="news-three__title"><a href="{{ route('newsDetails') }}">Which allows you to pay down
                                    insurance bills</a></h3>
                            <div class="news-three__arrow">
                                <a href="{{ route('newsDetails') }}"><span class="icon-right-arrow1"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    <div class="news-three__single">
                        <div class="news-three-bg" style="background-image: url('{{ asset('assets/images/blog/news-3-2.jpg') }}')">
                        </div>
                        <div class="news-three__client-info">
                            <div class="news-three__client-img">
                        ...
                        <div class="news-three__content">
                            <h3 class="news-three__title"><a href="{{ route('newsDetails') }}">Leverage agile frameworks to
                                    provide</a></h3>
                            <div class="news-three__arrow">
                                <a href="{{ route('newsDetails') }}"><span class="icon-right-arrow1"></span></a>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="news-three__single">
                        <div class="news-three-bg" style="background-image: url('{{ asset('assets/images/blog/news-3-3.jpg') }}')">
                        </div>
                        <div class="news-three__client-info">
                            <div class="news-three__client-img">
                        ...
                        <div class="news-three__content">
                            <h3 class="news-three__title"><a href="{{ route('newsDetails') }}">Bring to the table win-win
