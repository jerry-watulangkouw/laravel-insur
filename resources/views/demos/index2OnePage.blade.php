...
@section('content')
    ...
    <header class="main-header-two clearfix">
                            ...
                            <div class="main-menu-two__right">
                                <div class="main-menu-two__search-box-get-quote">
                                    <div class="main-menu-two__search-box">
                                        ...
                                        <a href="{{ route('cart') }}"
                                            class="main-menu-two__cart  insur-two-icon-shopping-cart"></a>
                                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-two"
                            style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-2-1.jpg') }}')"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-two"
                            style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-2-2.jpg') }}')"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-two"
                            style="background-image: url('{{ asset('assets/images/backgrounds/main-slider-2-3.jpg') }}')"></div>
                        <!-- /.image-layer -->
        ...
        <!--Services Two Start-->
        <section class="services-two" id="insurance">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('lifeInsurance') }}">Industrial Parts & Fabrication Project</a></h3>
                                        ...
                                        <div class="get-insuracne-two__tab-left">
                                            <ul class="tab-buttons clearfix list-unstyled">
                                                <li data-tab="#home" class="tab-btn active-btn">
                                                    <div class="get-insuracne-two__tab-btn-content">
                                                        <div class="get-insuracne-two__tab-icon">
                                                            <img src="{{ asset('assets/images/icon/get-insuracne-two-tab-icon-1.png') }}"
                                                                alt="">
                                                        </div>
                                                ...
                                                <li data-tab="#vehicles" class="tab-btn">
                                                    <div class="get-insuracne-two__tab-btn-content">
                                                        <div class="get-insuracne-two__tab-icon">
                                                            <img src="{{ asset('assets/images/icon/get-insuracne-two-tab-icon-2.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="get-insuracne-two__tab-text-box">
                                                ...
                                                <li data-tab="#life" class="tab-btn">
                                                    <div class="get-insuracne-two__tab-btn-content">
                                                        <div class="get-insuracne-two__tab-icon">
                                                            <img src="{{ asset('assets/images/icon/get-insuracne-two-tab-icon-3.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="get-insuracne-two__tab-text-box">
                                                ...
                                                <li data-tab="#business" class="tab-btn">
                                                    <div class="get-insuracne-two__tab-btn-content">
                                                        <div class="get-insuracne-two__tab-icon">
                                                            <img src="{{ asset('assets/images/icon/get-insuracne-two-tab-icon-4.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="get-insuracne-two__tab-text-box">
                                                    ...
                                                    <div class="get-insuracne-two__content">
                                                        <form class="get-insuracne-two__form">
                                                            ...
                                                            <div class="get-insuracne-two__content-bottom">
                                                                <button type="submit"
                                                                    class="thm-btn get-insuracne-two__btn">Get a Quote
                                                                    Now</button>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="testimonial-two__left">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">kmil testimonials</p>
                                    <div class="section-title-shape-1">
                                        <img src="{{ asset('assets/images/shapes/section-title-shape-1.png') }}" alt="">
                                    </div>
                                    <div class="section-title-shape-2">
                            ...
                            <div class="testimonial-two__point-box">
                                ...
                                <ul class="list-unstyled testimonial-two__point testimonial-two__point-two">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>We’re quick and reliable <br> project</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
