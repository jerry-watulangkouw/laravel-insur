                            ...
                            <div class="main-menu__wrapper-inner clearfix">
                                <div class="main-menu__left">
                                    ...
                                    <div class="main-menu__main-menu-box">
                                               ...
                                               {{-- <li
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('testimonialCarousel') }}">Teatimonials</a>
                                                        </li>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('homeInsurance') }}">Dies, Jig & Fixtures</a>
                                                        </li>
                                        ...
                                        <div class="main-menu__main-menu-box-search-get-quote-btn" style="display: flex; align-items: center; gap: 20px;">
                                            ...
                                            <div class="main-menu__call" style="display: flex; align-items: center; gap: 10px;">
                                                 <div class="main-menu__call-icon">
                                                     <i class="fas fa-phone"></i>
                                                 </div>
                                                 <div class="main-menu__call-content">
                                                    <a href="tel:9200368090">0813-1629-7120</a>
                                                    <p style="margin: 0;">Call to Our Experts</p>                                
                                        </div>
                                    </div>
                                </div>
                            </div>
