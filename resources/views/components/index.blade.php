                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="main-slider__content">
                                        <h2 class="main-slider__title">Insurance <br> Indonesia <br> family
                                            <span>life.</span></h2>
                                        <p class="main-slider__text">Our motto is "We Are The Quality"
                                             because Quality <br>only happens when we care enough to do our best.</p>
                                        <div class="main-slider__btn-box">
                        ...
                        <div class="about-one__right">
                            ...
                            <ul class="list-unstyled about-one__points">
                                <li>
                                    ...
                                    <div class="text">
                                        <p>PT. Kurnia Mustika Indah Lestari has been regarded nationally as one of the biggest precision parts specialist and engineering manufacturer in Indonesia and thus has become the trusted manufacturer for many company a personal touch.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                            ...
                            <p class="about-one__text-2">KMIL delivers precision-engineered solutions for industries demanding accuracy and reliability.</p>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="{{ route('lifeInsurance') }}">Industrial Parts & Fabrication Project</a></h2>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="{{ route('businessInsurance') }}">Dies Marking</a></h2>
                                    <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                        elit.</p>
                                </div>
                            </div>
